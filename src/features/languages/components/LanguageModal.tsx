...
interface Props {
  ...
  add_button_clk: Function;
  edit_button_clk: Function;
...
export default function LanguageModal({
  ...
  const [
    upload,
    { isLoading: uploading, isError: isErrorUploading, data: currentFilePath }
  ] = useUploadMutation();
    ...
    <ModalBody>
      <>
                ...
                <Input
                  ...
                  clear={() => {
                    if (
                      ...
                      setCurrentData({
                        ...currentData,
                        translations: currentData.translations?.map((one) => {
        ...
        {mode !== 'preview' ? (
          <ModalActionButton
            text={
              mode === 'add' ? trans('Add Language') : trans('Edit Language')
            }
            disabled={false}
            onClick={() => {
              if (mode === 'add') {
